...
eon_dsa <- read.csv("/Users/micaelarichter/Library/CloudStorage/OneDrive-TheOhioStateUniversity/python/configeon_dsa_deg100_r04.csv")
...
# true Rt data
true_sim <- read.csv("/Users/micaelarichter/Library/CloudStorage/OneDrive-TheOhioStateUniversity/python/config_deg100_r04.csv")
...
windows_deg100_4 <- adaptive_smooth1(c(4, 6, 8, 10))
